...
class PSD(torch.nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, diag_dim, nonlinearity='tanh', init_gain=0.0, epsilon=0.0):
    ...
    def forward(self, q):
        if self.diag_dim == 1:
            ...
            diag = diag + np.sqrt(self.epsilon)
